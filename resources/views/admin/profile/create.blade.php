        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-content">
              <div class="card-body">
                <form id="myForm" class="form" data-parsley-validate action="{{route('admin.profile.store') }}" method="POST" enctype="multipart/form-data">
                  @csrf
                    <div class="row">
                        <div class="col-md-12 col-12">
                            <div class="form-group mandatory @error('nama_kelurahan') is-invalid @enderror">
                                ...
                                <input type="text" id="nama_kelurahan-column" class="form-control @error('nama_kelurahan') is-invalid @enderror" placeholder="Masukkan Nama Kelurahan" name="nama_kelurahan" value="{{ old('nama_kelurahan') }}" required>
