        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-content">
              <div class="card-body">
                <form id="myForm" class="form" data-parsley-validate action="{{ route('admin.artikel.update', $artikel->id) }}" method="POST" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    <div class="row">
                        <div class="col-md-12 col-12">
                            <div class="form-group mandatory @error('judul') is-invalid @enderror">
                                ...
                                <input type="text" id="judul-column" class="form-control @error('judul') is-invalid @enderror" placeholder="Masukkan Judul" name="judul" value="{{ $artikel->judul }}" required>
                                @error('judul')
                    ...
                    <div class="row">
                        <div class="col-md-12 col-12">
                            <div class="form-group mandatory @error('tgl_for_set') is-invalid @enderror"">
                                ...
                                <input type="datetime-local" id="tgl_for_set-column" class="form-control @error('tgl_for_set') is-invalid @enderror" placeholder="Pilih Tanggal Berapa Artikel Akan di Publish" name="tgl_for_set" value="{{ $artikel->original_tgl }}" min="{{ $artikel->original_tgl }}">
                                @error('tgl_for_set')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
