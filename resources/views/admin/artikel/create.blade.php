                    ...
                    <div class="row">
                        <div class="col-md-12 col-12">
                            <div class="form-group mandatory @error('tgl_for_set') is-invalid @enderror">
                                ...
                                <input type="datetime-local" id="tgl_for_set-column" class="form-control @error('tgl_for_set') is-invalid @enderror" placeholder="Pilih Tanggal Berapa Artikel Akan di Publish" name="tgl_for_set" value="{{ old('tgl_for_set') }}" required>
                                @error('tgl')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
